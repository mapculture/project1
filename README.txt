...
Obtain an API key of Google Maps Javascript API, Directions API, Distance Matrix API

Put your API key on line 8 of /flask_app/getmap/templates/getmap.html

Build a Docker image, create and run a Docker container using docker-compose:
